...
def main() -> int:
    ...
    expect("image/phase1/" not in factory_lua, "runtime still depends on custom PNG assets")
    expect("NoTextureUnlit.xml" in factory_lua, "procedural unlit visual material missing")
