...
own("runtime", {
    ...
    "laboratoryBoundaries_", "apple_", "applePreSolveVelocity_", "mapper_", "audio_", "levelIndex_",
})
...
function State.New(dependencies, constants)
    ...
    context.apple_, context.applePreSolveVelocity_, context.mapper_, context.frame_, context.audio_ = nil, nil, nil, nil, nil
